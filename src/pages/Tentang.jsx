                    ...
                    <h2>Tentang Kami</h2>
                        <div className="about-content">
                            <div className="about-text">
                                <p><strong>FarmEduz</strong> adalah platform edukasi pertanian berbasis teknologi untuk masyarakat Indonesia, khususnya Gen Z.</p><br />
                                <p>Kami menyediakan berbagai course yang dirancang untuk memajukan inovasi sektor pertanian masa depan di Indonesia.</p><br/>
