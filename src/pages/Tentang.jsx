                ...
                <section className="features">
                    ...
                    <div className="feature-list">
                        <div className="feature-item">
                            <img src="#" alt="Sertifikasi" class="feature-icon"/>
                            <h4>Sertifikasi</h4>
                            <p>Setiap kali berhasil menyelesaikan sebuah kelas, kamu akan mendapatkan Sertifikat.</p>
                        </div>
                        <div className="feature-item">
                            <img src="#" alt="Personalized Learning" class="feature-icon"/>
                        ...
                        <div className="feature-item">
                            <img src="#" alt="Pembelajaran Video" class="feature-icon"/>
                        ...
                        <div className="feature-item">
                            <img src="#" alt="Kebutuhan Pertanian" class="feature-icon"/>
