                    ...
                    <div className="product-container">
                        ...
                        <div className="product-card">
                            ...
                            <div className="product-info">
                                ...
                                <span className="price">$10</span><span className="actual-price">$30</span>
                            </div>
                        </div>
                        ...
                        <div className="product-card">
                            ...
                            <div className="product-info">
                                <p className="product-short-description">a short line about the cloth..</p>
                                <span className="price">$15</span><span className="actual-price">$30</span>
                            </div>
                        </div>
                        ...
                        <div className="product-card">
                            ...
                            <div className="product-info">
                                <p className="product-short-description">a short line about the cloth..</p>
                                <span className="price">$25</span><span className="actual-price">$45</span>
                            </div>
                        </div>
