...
function Admin() {
  const [activeTab, setActiveTab] = useState("Admin"); // Untuk tab navigasi
  ...
  const handleAddNew = () => {
    alert("Add New Admin clicked");
  };

  const handleImportMembers = () => {
    alert("Import Admin clicked");
  };

  const handleExportMembers = () => {
    alert("Export Admin clicked");
  };
    ...
    <div className="d-flex">
      ...
      {sidebarOpen && (
        <nav className="sidebar-admin">
          <div className="p-4">
            <h4 className="text-white">FarmEdu<span style={{color:"#ef7a53"}}>Z</span> Admin</h4>
          </div>
      ...
      <div className="content-admin flex-grow-1">
        ...
        <div className="container-admin mt-4 px-4">
          ...
          <div className="d-flex border-bottom">
            ...
            <button
              className={`btn ${
                activeTab === "Admin" ? "border-bottom border-primary fw-bold" : ""
              }`}
