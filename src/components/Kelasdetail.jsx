import detailkelas from "../assets/detailkelas.jpg";
const Kelasdetail = () => {
	return (
		<div className="container" style={{ marginBottom: "23%" }}>
			<div className="row display-flex flex-wrap-wrap gap-20px">
				...
				<div className="col-md-8">
					...
					<img src={detailkelas} alt="Drone Pertanian" className="course-image" />
					<p className="course-description">
						...
						dirancang untuk memberikan pengetahuan praktis dalam mengoperasikan
						drone, memetakan lahan, dan menganalisis data pertanian secara
						cerdas. Cocok bagi pemula maupun profesional yang ingin
						mengembangkan keterampilan di era pertanian 4.0.
					</p>
